...
<div class="section-title">Perfomance Dashboard</div>
    ...
    <div class="section-title">
        ...
        <div class="chart-navigation">
            <button class="chart-nav-btn active" data-chart="all">All Charts</button>
            <button class="chart-nav-btn" data-chart="project">Projects</button>
            <button class="chart-nav-btn" data-chart="audit">Audits</button>
            <button class="chart-nav-btn" data-chart="skills">Skills</button>
        </div>
    </div>
    <div class="additional-charts">
        <div class="chart-row">
            <div class="chart-container chart-project" id="project-success-chart"></div>
            <div class="chart-container chart-audit" id="audit-ratio-chart"></div>
        </div>
        <div class="chart-row">
            <div class="chart-container chart-skills" id="skills-radar-chart"></div>
        </div>
    </div>
`
